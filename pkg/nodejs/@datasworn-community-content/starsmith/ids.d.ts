...
export declare const OracleIds: {
	...
	readonly core: {
		readonly action: 'oracle_rollable:starsmith/core/action'
		readonly theme: 'oracle_rollable:starsmith/core/theme'
	...
	readonly faction: {
		...
		readonly data_harvester_role: 'oracle_rollable:starsmith/faction/data_harvester_role'
		readonly religious_role: 'oracle_rollable:starsmith/faction/religious_role'
	...
	readonly misc: {
		readonly story_complication: 'oracle_rollable:starsmith/misc/story_complication'
		readonly story_clue: 'oracle_rollable:starsmith/misc/story_clue'
		readonly combat_action: 'oracle_rollable:starsmith/misc/combat_action'
		readonly anomaly_effect: 'oracle_rollable:starsmith/misc/anomaly_effect'
		readonly item: 'oracle_rollable:starsmith/misc/item'
		readonly complication: 'oracle_rollable:starsmith/misc/complication'
		readonly clue: 'oracle_rollable:starsmith/misc/clue'
		readonly action: 'oracle_rollable:starsmith/misc/action'
	...
	readonly space: {
		...
		readonly peril: 'oracle_rollable:starsmith/space/peril'
		readonly opportunity: 'oracle_rollable:starsmith/space/opportunity'
		readonly sighting: {
			readonly terminus: 'oracle_rollable:starsmith/space/sighting/terminus'
			readonly outlands: 'oracle_rollable:starsmith/space/sighting/outlands'
			readonly expanse: 'oracle_rollable:starsmith/space/sighting/expanse'
		}
		readonly sector_name: {
			readonly prefix: 'oracle_rollable:starsmith/space/sector_name/prefix'
