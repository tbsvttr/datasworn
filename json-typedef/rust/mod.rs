...
pub struct MoveActionRollEnhancement {
    #[serde(rename = "enhances")]
    pub enhances: Option<Box<Vec<AnyMoveIdWildcard>>>,
...
pub struct OracleRoll {
    ...
    #[serde(rename = "dice")]
    pub dice: Option<Box<DiceExpression>>,
    ...
    #[serde(rename = "oracle")]
    pub oracle: Option<Box<OracleRollableId>>,
}
...
pub struct OracleRollableRowText2 {
    ...
    #[serde(rename = "text2")]
    pub text2: Option<Box<MarkdownString>>,
...
pub struct OracleRollableRowText3 {
    ...
    #[serde(rename = "text3")]
    pub text3: Option<Box<MarkdownString>>,
...
pub struct TagRule {
    ...
    pub nodeTypes: Option<Box<Vec<TaggableNodeType>>>,
}
...
pub struct TriggerActionRollConditionEnhancement {
    ...
    /// The options available when rolling with this trigger condition.
    #[serde(rename = "roll_options")]
    pub rollOptions: Option<Box<Vec<RollableValue>>>,
